...
(function() {
    ...
    const CONFIG = {
        ...
        // Advanced features
        useOpeningBook: false,       // DISABLED - Let AlphaZero play its unique style freely
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // ENHANCED OPENING BOOK - Solid, Sound Openings Only
    // ═══════════════════════════════════════════════════════════════════════
    const OpeningBook = {
        openings: {
            // ===== WHITE OPENINGS =====
            ...
            // After 1.e4 e5 - Italian/Spanish setups
            'rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR w KQkq e6 0 2': ['g1f3', 'b1c3'],
            'rnbqkbnr/pppp1ppp/8/4p3/4P3/5N2/PPPP1PPP/RNBQKB1R b KQkq - 0 2': ['b8c6', 'g8f6'],
            'r1bqkbnr/pppp1ppp/2n5/4p3/4P3/5N2/PPPP1PPP/RNBQKB1R w KQkq - 0 3': ['f1b5', 'f1c4', 'd2d4'],
            'r1bqkbnr/pppp1ppp/2n5/1B2p3/4P3/5N2/PPPP1PPP/RNBQK2R b KQkq - 0 3': ['a7a6', 'g8f6'],
            
            // After 1.d4
            'rnbqkbnr/pppppppp/8/8/3P4/8/PPP1PPPP/RNBQKBNR b KQkq d3 0 1': ['d7d5', 'g8f6', 'e7e6'],
            
            // After 1.d4 d5
            'rnbqkbnr/ppp1pppp/8/3p4/3P4/8/PPP1PPPP/RNBQKBNR w KQkq d6 0 2': ['c2c4', 'g1f3', 'b1c3'],
            'rnbqkbnr/ppp1pppp/8/3p4/2PP4/8/PP2PPPP/RNBQKBNR b KQkq c3 0 2': ['e7e6', 'c7c6', 'g8f6'],
            
            // After 1.d4 Nf6
            'rnbqkb1r/pppppppp/5n2/8/3P4/8/PPP1PPPP/RNBQKBNR w KQkq - 0 2': ['c2c4', 'g1f3', 'b1c3'],
            'rnbqkb1r/pppppppp/5n2/8/2PP4/8/PP2PPPP/RNBQKBNR b KQkq c3 0 2': ['e7e6', 'g7g6', 'd7d5'],
            
            // ===== BLACK DEFENSES =====
            // Against 1.e4 - Sicilian
            'rnbqkbnr/pp1ppppp/8/2p5/4P3/8/PPPP1PPP/RNBQKBNR w KQkq c6 0 2': ['g1f3', 'b1c3'],
            'rnbqkbnr/pp1ppppp/8/2p5/4P3/5N2/PPPP1PPP/RNBQKB1R b KQkq - 0 2': ['d7d6', 'b8c6', 'e7e6'],
            'rnbqkbnr/pp2pppp/3p4/2p5/4P3/5N2/PPPP1PPP/RNBQKB1R w KQkq - 0 3': ['d2d4', 'f1b5'],
            
            // French Defense
            'rnbqkbnr/pppp1ppp/4p3/8/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2': ['d2d4', 'b1c3', 'g1f3'],
            'rnbqkbnr/pppp1ppp/4p3/8/3PP3/8/PPP2PPP/RNBQKBNR b KQkq d3 0 2': ['d7d5', 'b8c6'],
            
            // Caro-Kann
            'rnbqkbnr/pp1ppppp/2p5/8/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2': ['d2d4', 'b1c3'],
            'rnbqkbnr/pp1ppppp/2p5/8/3PP3/8/PPP2PPP/RNBQKBNR b KQkq d3 0 2': ['d7d5', 'g8f6'],
            
            // Against 1.d4 - King's Indian setup
            'rnbqkb1r/pppppp1p/5np1/8/2PP4/8/PP2PPPP/RNBQKBNR w KQkq - 0 3': ['b1c3', 'g1f3'],
            'rnbqkb1r/pppppp1p/5np1/8/2PP4/2N5/PP2PPPP/R1BQKBNR b KQkq - 0 3': ['f8g7', 'd7d6'],
            
            // Queen's Gambit Declined
            'rnbqkbnr/ppp2ppp/4p3/3p4/2PP4/8/PP2PPPP/RNBQKBNR w KQkq d6 0 3': ['b1c3', 'g1f3'],
            'rnbqkbnr/ppp2ppp/4p3/3p4/2PP4/2N5/PP2PPPP/R1BQKBNR b KQkq - 0 3': ['g8f6', 'f8e7'],
            
            // Nimzo-Indian
            'rnbqk2r/pppp1ppp/4pn2/8/1bPP4/2N5/PP2PPPP/R1BQKBNR w KQkq - 0 4': ['e2e3', 'g1f3', 'c1d2'],
            
            // AVOID WEAK MOVES - explicitly block bad responses
            // No early Queen moves
            'rnbqkbnr/ppp1pppp/8/3p4/3P4/8/PPP1PPPP/RNBQKBNR w KQkq d6 0 2': ['c2c4', 'g1f3', 'b1c3'], // Never Nc3-Qd6
            'rnbqkbnr/ppp1pppp/8/3p4/3P4/2N5/PPP1PPPP/R1BQKBNR b KQkq - 0 2': ['g8f6', 'e7e6', 'c7c6'], // Never Qd6!
        },
    ...
    const EngineManager = {
        ...
        analyzePosition(fen) {
            ...
            try {
                ...
                // Check opening book (DISABLED for pure AlphaZero play)
                if (CONFIG.useOpeningBook && STATE.moveCount <= 6) {
                    ...
                    Logger.info(`♾️  AlphaZero computing original move (no book)`);
                }
    ...
    // ═══════════════════════════════════════════════════════════════════════
    function initialize() {
        Logger.banner('🏆 Lichess Lc0 Bot - AlphaZero MCTS Edition v3.2 (Enhanced)');
        ...
        console.log('%c🔧 ENHANCED: Advanced Recovery + Perfect Tactical Play', 'color: #FF9800; font-size: 14px; font-weight: bold;');
        console.log('%c♾️  Opening Book DISABLED - Pure AlphaZero Style!', 'color: #9C27B0; font-size: 14px; font-weight: bold;');
        console.log('');
