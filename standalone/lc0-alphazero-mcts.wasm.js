...
window.LEELA = (function() {
    ...
    // MCTS Configuration - OPTIMIZED FOR SPEED
    const MCTS_CONFIG = {
        simulations: 400,            // Reduced for faster moves (was 1600)
        cPuct: 1.5,                  // PUCT exploration constant
        temperature: 0.0,            // Deterministic for speed
        dirichletAlpha: 0.3,         // Dirichlet noise alpha
        dirichletEpsilon: 0.15,      // Reduced noise for faster convergence
        virtualLoss: 3,              // Virtual loss for parallel search
        minVisitsForExpansion: 1,    // Min visits before expanding
        maxDepthMinimax: 6,          // Reduced depth for speed
        evaluationMode: 'mcts'       // Pure MCTS for consistency
    };
