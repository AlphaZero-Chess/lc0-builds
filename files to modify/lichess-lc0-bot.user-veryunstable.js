...
// @grant        none
// @require      https://cdn.jsdelivr.net/gh/AlphaZero-Chess/lc0-builds@refs/heads/main/lc0-fast-anti-blunder.wasm.js
// ==/UserScript==
...
(function() {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    const CONFIG = {
        // Engine settings (FAST Anti-Blunder)
        movetime: 1500,              // Base thinking time (ms) - FAST!
        nodes: null,                 // Node count (null = use movetime)
        depth: 20,                   // Search depth (minimax)
        multiPV: 1,                  // Number of lines to analyze
        threads: 1,                  // CPU threads
        useSEE: true,                // SEE anti-blunder system
        useMCTS: false,              // Using minimax for speed
