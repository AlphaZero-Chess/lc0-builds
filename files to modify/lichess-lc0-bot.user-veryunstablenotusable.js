...
// @grant        none
// @require      https://cdn.jsdelivr.net/gh/AlphaZero-Chess/lc0-builds@refs/heads/main/lc0-alphazero-top-tier-PATCHED.wasm.js
// ==/UserScript==
...
(function() {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    const CONFIG = {
        // Engine settings (AlphaZero MCTS - PATCHED)
        movetime: 2500,              // Base thinking time (ms) - optimized
        nodes: null,                 // Node count (null = use movetime)
        simulations: 2000,           // MCTS simulations per move (INCREASED)
        depth: null,                 // Search depth (null = unlimited)
        multiPV: 1,                  // Number of lines to analyze
        threads: 2,                  // CPU threads
        temperature: 0.05,           // Move randomness (LOWERED for deterministic)
        cPuct: 1.8,                  // PUCT exploration constant (INCREASED for tactics)
