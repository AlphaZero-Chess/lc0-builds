...
(function() {
    ...
    const CONFIG = {
        // Engine settings
        movetime: 1500,              // Base thinking time (ms)
    ...
    window.Lc0Bot = {
        ...
        help() {
            ...
            console.log('%c  window.Lc0Bot.setTemperature(t)%c    - Set temperature', 'color: #4CAF50; font-weight: bold;', '');
    ...
    // ═══════════════════════════════════════════════════════════════════════
    function initialize() {
        Logger.banner('🤖 Lichess Lc0 Bot - Top Tier Edition v2.0');
        ...
        Logger.system(`Bot ready with config: ${CONFIG.movetime}ms think time, MultiPV=${CONFIG.multiPV}`);
        console.log('');
        Logger.success('✓ Lc0Bot loaded successfully!');
